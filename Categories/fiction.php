...
<section class="books-page-grid">
    ...
    <a href="../Books/animalfarm.php">
    <div class="book-card">
        <img src="../pics/books/animalfarm.jpg" alt="Burnt Shadows">
    ...
    <a href="../Books/david.php">
    <div class="book-card">
        <img src="../pics/books/david.jpg" alt="David CopperFeild">
        <h3>David CopperFeild</h3>
        <p>Charles Dickens</p>
    </div>
    </a>
