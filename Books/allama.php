...
<head>
  ...
  <title>Religious Thoughts | Book</title>
...
<main class="book-container">
  ...
  <div class="book-header">
    ...
    <div class="book-cover-wrapper">
      <img 
        src="../Pics/books/allama.jpg"
        alt="Reconstruction of Religious thoughts in Islam" 
        class="book-cover"
      />
    </div>

    <div class="book-info">
      <h1 class="book-title">Reconstruction of Religious Thoughts</h1>
      <p class="book-author">Allama Muhammad Iqbal</p>
...
<div class="genres">
  ...
  <span class="genre-tag">Islam</span>
        ...
        <div class="action-buttons">
          <button class="btn primary" onclick="window.open('../PDFs/allama.pdf', '_blank')">Read Now</button>
