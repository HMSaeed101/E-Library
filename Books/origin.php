...
<head>
  ...
  <title>Origin of Species | Book</title>
...
<main class="book-container">
  ...
  <div class="book-header">
    ...
    <div class="book-cover-wrapper">
      <img 
        src="../Pics/books/origin.jpg"
        alt="Origin of Species" 
        class="book-cover"
      />
    </div>

    <div class="book-info">
      <h1 class="book-title">Origin of Species</h1>
      <p class="book-author">Charles Darwin</p>
        
<div class="meta-row">
    <span class="meta-item">1859</span>
    <span class="meta-item">502 pages</span>
...
<div class="genres">
  ...
  <span class="genre-tag">Biology</span>
  <span class="genre-tag">Evolution</span>
</div>

<div class="action-buttons">
  <button class="btn primary" onclick="window.open('../PDFs/origin.pdf', '_blank')">Read Now</button>
  ...
  <div class="details-grid">
    <div class="detail-item">
      ...
      <span class="value">John Murray</span>
    </div>
    <div class="detail-item">
      <span class="label">ISBN</span>
      <span class="value">978-0451529060</span>
    </div>
    <div class="detail-item">
      <span class="label">Publication Date</span>
      <span class="value">November 24, 1859</span>
    </div>
    <div class="detail-item">
