...
<head>
  ...
  <title>Inheritance of Loss | Book</title>
...
<main class="book-container">
  ...
  <div class="book-header">
    ...
    <div class="book-info">
      <h1 class="book-title">The Inheritance of Loss</h1>
      <p class="book-author">Kiran Desai</p>
        
    <div class="meta-row">
        <span class="meta-item">Standalone</span>
        <span class="meta-item">357 pages</span>
        ...
        <div class="genres">
          ...
          <span class="genre-tag">Postcolonial Literature</span>
          <span class="genre-tag">Historical Fiction</span>
        </div>

        <div class="action-buttons">
          <button class="btn primary" onclick="window.open('../PDFs/inheritance-of-loss.pdf', '_blank')">Read Now</button>
    ...
    <section class="book-details-section">
      ...
      <div class="details-grid">
        <div class="detail-item">
          ...
          <span class="value">Atlantic Monthly Press</span>
        </div>
        <div class="detail-item">
          <span class="label">ISBN</span>
          <span class="value">978-0802142818</span>
        </div>
        <div class="detail-item">
          <span class="label">Publication Date</span>
          <span class="value">August 29, 2006</span>
        </div>
        <div class="detail-item">
